...
np.save(learning_data_root+'inceptionv3_bottleneck_labels_training.npy', train_labels)
...
np.save(learning_data_root+'inceptionv3_bottleneck_labels_validation.npy', validation_labels)
print("Saved bottleneck labels for validation")
vaidation_labels = None
