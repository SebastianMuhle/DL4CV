...
from Xception_bottleneck import save_bottleneck_features
import pandas as pd
...
train_data = np.load(learning_data_root+'xception_bottleneck_features_train.npy')
validation_data = np.load(learning_data_root+'xception_bottleneck_features_validation.npy')
train_labels = np.load(learning_data_root+'xception_bottleneck_labels_training.npy')
validation_labels = np.load(learning_data_root+'xception_bottleneck_labels_validation.npy')
