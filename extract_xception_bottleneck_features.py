...
np.save(learning_data_root+'xception_bottleneck_labels_training.npy', train_labels)
...
np.save(learning_data_root+'xception_bottleneck_labels_validation.npy', validation_labels)
